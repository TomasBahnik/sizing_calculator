...
from constants import UUID_COLUMN, TEST_ENV_KEY, MMM_DB_METRICS_KEY, EVENT_MMM_BUILD_VERSION_KEY
...
BASIC_COLUMNS = [FROM_TIME_ALIAS, TO_TIME_ALIAS, UUID_COLUMN]
...
MMM_BUILD_VERSION_COLUMN = camel_to_snake(EVENT_MMM_BUILD_VERSION_KEY)
TEST_ENV_COLUMN = camel_to_snake(TEST_ENV_KEY)
MMM_DB_METRICS_COLUMN = camel_to_snake(MMM_DB_METRICS_KEY)
LIST_COLUMNS = BASIC_COLUMNS + [TEST_ENV_KEY, EVENT_MMM_BUILD_VERSION_KEY]
